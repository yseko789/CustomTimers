...
//                it.setBackgroundResource(R.drawable.ic_baseline_pause_24)
        ...
        viewModel.setOriginalTime(navigationArgs.hours, navigationArgs.minutes, navigationArgs.seconds,navigationArgs.task)
        viewModel.setProgressTime()
        viewModel.buildTimer()

        binding.endBtn.setOnClickListener{
            val action = TimerFragmentDirections.actionTimerFragmentToListFragment()
